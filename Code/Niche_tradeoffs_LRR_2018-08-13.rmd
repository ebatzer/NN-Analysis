...
```{r Calculating LRRs, eval=F,include=F}
rm(list=ls())

# Read biomass data
biomass_data <- fread("~/Dropbox/Comp-Sync/Projects/Nutnet_base_data/comb-by-plot-09-April-2018.csv",stringsAsFactors = F,na.strings=c("NULL",'NA'))
...
cover <- data.table(read.csv('~/Dropbox/Comp-Sync/Projects/Nutnet_base_data/full-cover-09-April-2018.csv',na.strings = c('NA','NULL')))
