...
pc1_fit <- data.frame(t((pc1_loadings) %*% t(c(-30, 30))))
...
scatter3D(z = smadat$trt_N, x = smadat$trt_P, y = smadat$trt_K, pch = 19, cex = 1,
      theta = theta, phi = phi, col = "black",
      xlab = "P Response", ylab = "K Response", zlab = "N Response", type = "h",
      main = "Overall Treatment Responses", alpha = .1, colkey = FALSE, ticktype = "detailed")

scatter3D(z = pc1_fit$N, x = pc1_fit$P, y = pc1_fit$K, pch = 19, lwd = 2,
      theta = theta, phi = phi, col = "red", add = TRUE, type = "l", lty = 2)
```
